...
//   useEffect(() => {
//     // if (verify) {
//     const url = `http://localhost:1200/api/user/${userId}`;
...
//           <div>
//             <div className="bg-blue-100 flex justify-between px-10 pt-16 pb-52">
...
//                   ></img>
//                 )}
//                 <h3 className="pt-4 font-open-sans">{name}</h3>
...
// // make the image on top of the data card and have the edit/save btton below the image and above the data
import React, { useState, useEffect } from "react";
import axios from "axios";
import Cookies from "js-cookie";
import { useNavigate } from "react-router-dom";
